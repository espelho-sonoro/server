def video_info(db):
    ...
    def __init__(self, video_id, bandcamp_track_id, rec_latitude, rec_longitude):
...
class VideoInfoDAO(object):
    ...
    def save(self, video_id, bandcamp_track_id, rec_latitude, rec_longitude):
        element = self.clazz(video_id, bandcamp_track_id, rec_latitude, rec_longitude)
